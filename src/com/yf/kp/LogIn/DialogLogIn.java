...
public class DialogLogIn extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/yf/kp/images/LogoSMP.png"))); // NOI18N
...
public void login (DialogLogIn view ) {
        ...
        try {
            ...
            if (username.trim().isEmpty()) {
                JOptionPane.showMessageDialog(view, "Username Kosong!");
            } else if (password.trim().isEmpty()) {
                JOptionPane.showMessageDialog(view, "Password Kosong!");
            } else if (!username.equals(user.getUsername()) && (!password.equals(user.getPassword()))) {
                JOptionPane.showMessageDialog(view, "Username atau Password Tidak Valid!");
            } else {
            ...
            JOptionPane.showMessageDialog(view, "Aplikasi Belum Terkoneksi Ke Database\n" + e.getMessage(), "Peringatan", JOptionPane.ERROR_MESSAGE);
        }
    }
