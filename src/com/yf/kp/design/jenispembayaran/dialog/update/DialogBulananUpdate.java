 ...
 * @author Khasdul
 */
public class DialogBulananUpdate extends java.awt.Dialog {
     ...
     */
    public DialogBulananUpdate(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setChkAgustus(Boolean chkAgustus) {
        this.chkAgustus.setSelected(chkAgustus);
    }

    public void setChkApril(Boolean chkApril) {
        this.chkApril.setSelected(chkApril);
    }

    public void setChkDesember(Boolean chkDesember) {
        this.chkDesember.setSelected(chkDesember);
    }

    public void setChkFebruari(Boolean chkFebruari) {
        this.chkFebruari.setSelected(chkFebruari);
    }

    public void setChkJanuari(Boolean chkJanuari) {
        this.chkJanuari.setSelected(chkJanuari);
    }

    public void setChkJuli(Boolean chkJuli) {
        this.chkJuli.setSelected(chkJuli);
    }

    public void setChkJuni(Boolean chkJuni) {
        this.chkJuni.setSelected(chkJuni);
    }

    public void setChkMaret(Boolean chkMaret) {
        this.chkMaret.setSelected(chkMaret);
    }

    public void setChkMei(Boolean chkMei) {
        this.chkMei.setSelected(chkMei);
    }

    public void setChkNovember(Boolean chkNovember) {
        this.chkNovember.setSelected(chkNovember);
    }

    public void setChkOktober(Boolean chkOktober) {
        this.chkOktober.setSelected(chkOktober);
    }

    public void setChkSeptember(Boolean chkSeptember) {
        this.chkSeptember.setSelected(chkSeptember);
    }
